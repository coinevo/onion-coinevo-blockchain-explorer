...
CurrentBlockchainStatus::load_current_emission_amount()
{
    ...
    string last_saved_emmision = evoeg::read(emmision_saved_file);
...
bf::path CurrentBlockchainStatus::blockchain_path {"/home/mwo/.bitcoinevo/lmdb"};
...
string CurrentBlockchainStatus::deamon_url {"http:://127.0.0.1:33331"};
...
evoeg::MicroCore*  CurrentBlockchainStatus::mcore {nullptr};
}
