...
if (EXISTS ${COINEVO_BUILD_DIR}/src/ringct/libringct_basic.a)
	message(STATUS FindCoinevo " found libringct_basic.a")
	add_library(ringct_basic STATIC IMPORTED)
	set_property(TARGET ringct_basic
			PROPERTY IMPORTED_LOCATION ${COINEVO_BUILD_DIR}/src/ringct/libringct_basic.a)
endif()


message(STATUS ${COINEVO_SOURCE_DIR}/build)

# include coinevo headers
include_directories(
		${COINEVO_SOURCE_DIR}/src
                ${COINEVO_SOURCE_DIR}/src/crypto
		${COINEVO_SOURCE_DIR}/external
		${COINEVO_SOURCE_DIR}/external/randomx/src
